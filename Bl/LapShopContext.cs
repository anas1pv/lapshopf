...
public partial class LapShopContext : IdentityDbContext<ApplicationUser>//<IdentityUser>// DbContext
{
        ...
        : base(options)
    {
        ...
        {
            var sql = @"
            IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='TbItemEvaluations' AND xtype='U')
            CREATE TABLE TbItemEvaluations (
                EvaluationId INT IDENTITY(1,1) PRIMARY KEY,
                ItemId INT NOT NULL FOREIGN KEY REFERENCES TbItems(ItemId),
            ...
            var sqlCoupons = @"
            IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='TbCoupons' AND xtype='U')
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbPurchaseInvoice>(entity =>
        {
            ...
            entity.Property(e => e.InvoiceDate)
                .HasDefaultValueSql("(getdate())", "DF_TbPurchaseInvoices_InvoiceDate")
        ...
        modelBuilder.Entity<TbPurchaseInvoiceItem>(entity =>
        {
            ...
            entity.Property(e => e.Qty).HasDefaultValue(1.0, "DF_TbPurchaseInvoiceItems_Qty");
        ...
        modelBuilder.Entity<TbSalesInvoice>(entity =>
        {
            ...
            entity.Property(e => e.InvoiceDate)
                .HasDefaultValueSql("(getdate())", "DF_TbSalesInvoices_InvoiceDate")
                .HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<TbSalesInvoiceItem>(entity =>
        {
            ...
            entity.Property(e => e.Qty).HasDefaultValue(1.0, "DF_TbSalesInvoiceItems_Qty");
        ...
        modelBuilder.Entity<TbItemEvaluation>(entity =>
        {
