...
namespace lapshop.Migrations
{
    ...
    [Migration("20260425174114_aspidentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lapshop.Domains.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.TbItem", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbPurchaseInvoiceItem", b =>
                {
                    ...
                    b.Property<double>("Qty")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(1.0, "DF_TbPurchaseInvoiceItems_Qty");
            ...
            modelBuilder.Entity("lapshop.Domains.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("Qty")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(1.0, "DF_TbSalesInvoiceItems_Qty");
            ...
            modelBuilder.Entity("lapshop.Domains.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("lapshop.Domains.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lapshop.Domains.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("lapshop.Domains.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("lapshop.Domains.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lapshop.Domains.TbItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("lapshop.Domains.TbBusinessInfo", b =>
                {
                    b.HasOne("lapshop.Domains.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("lapshop.Domains.TbBusinessInfo", "CutomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("lapshop.Domains.TbItem", b =>
                {
                    b.HasOne("lapshop.Domains.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("lapshop.Domains.TbItemType", "ItemType")
                        .WithMany("TbItems")
                    ...
                    b.HasOne("lapshop.Domains.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("lapshop.Domains.TbItemDiscount", b =>
                {
                    b.HasOne("lapshop.Domains.TbItem", "Item")
            ...
            modelBuilder.Entity("lapshop.Domains.TbPurchaseInvoice", b =>
                {
                    b.HasOne("lapshop.Domains.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("lapshop.Domains.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("lapshop.Domains.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("lapshop.Domains.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("lapshop.Domains.TbSalesInvoice", "Invoice")
